...
class RecipeFavoriteAdapter (val recipes: MutableList<Recipe>, val fragment: FavoriteFragment) :
    RecyclerView.Adapter<RecipeFavoriteAdapter.RecipeFavoriteViewHolder>() {


    class RecipeFavoriteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecipeFavoriteViewHolder {
        ...
        val holder = RecipeFavoriteViewHolder(itemView)

        holder.itemView.setOnClickListener {
            fragment.showRecipeInFavorite(holder.adapterPosition)
        }

        holder.itemView.imageRecipeAddFavorite.setOnClickListener {
            fragment.changeFavoriteRecipeInFavorite(holder.adapterPosition)
        }
    ...
    override fun onBindViewHolder(holder: RecipeFavoriteViewHolder, position: Int) {
